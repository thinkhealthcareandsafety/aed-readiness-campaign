...
export const CHECKLIST_ITEMS = [
  ...
  },
  {
    ...
    mediaType: "image",
    prompt:
      "Assess the AED wall cabinet or carry case: door/lid closes properly, no cracked glass or " +
      "broken latch, visible and unobstructed. Set passed=true if the cabinet looks intact and " +
