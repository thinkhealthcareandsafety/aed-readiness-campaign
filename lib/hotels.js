// Nine cities used to appear twice here — once as a short "Courtyard
// <city>" and again as the brand's actual full name "Courtyard by
// Marriott <city>" (see the removal migration in lib/db.js for the exact
// list) — the same property listed under two slightly different names.
// Kept the full "by Marriott" form throughout, matching how every other
// sub-brand in this list (Fairfield by Marriott, Four Points by Sheraton,
// ...) is always written in its one full form, never abbreviated.
export const HOTELS = [
