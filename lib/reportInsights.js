import { questionMax, questionPoints } from "./genericScoring";
...
const RULES = {
  ...
  "label:self-test passed (if display available)?": {
    byValue: {
      passed: "Self-test passed successfully.",
      nodisplay: "This model has no digital self-test display — rely on the visual ready indicator and a manual monthly inspection instead.",
      failed: "Self-test failed. This is one of the clearest signals an AED needs service — don't wait for the next audit cycle to act on it.",
    },
  },
