...
const EXPIRY_OPTIONS = [
  ...
  { value: "within1m", label: "Within the next month", points: 1 },
  { value: "within1w", label: "Within the next week", points: 0 },
  ...
  return [
      ...
      questions: [
        {
          ...
          // 6/10 (not 3/5) so this question alone carries the section's
          // full 10-point weight — see the model-quantity question below,
          // which used to split this weight with it but is not a real
          // quality signal.
        ...
        },
        {
          ...
          // Unscored (0 points each): every listed model is an equally
          // legitimate, commonly-serviced unit, so "which brand" was never
          // a meaningful quality signal to grade — it only existed to force
          // *some* selection. See the AED-count question above, which now
          // carries this section's whole 10-point weight instead.
          options: [
            { value: "frx", label: "Philips FRX AED", points: 0, imageUrl: "/aed-models/frx.jpg" },
            { value: "hs1", label: "Philips HS1 Onsite AED", points: 0, imageUrl: "/aed-models/hs1.jpg" },
            { value: "zollPlus", label: "Zoll AED Plus", points: 0, imageUrl: "/aed-models/zoll-plus.jpg" },
            { value: "g5", label: "Cardiac Science G5 AED", points: 0, imageUrl: "/aed-models/cardiac-g5.jpg" },
            { value: "defibtech", label: "Defibtech AED", points: 0, imageUrl: "/aed-models/defibtech.jpg" },
            { value: "crPlus", label: "Physio-Control CR Plus", points: 0, imageUrl: "/aed-models/physio-cr-plus.jpg" },
            { value: "lp1000", label: "Physio-Control LP 1000", points: 0, imageUrl: "/aed-models/physio-lp1000.jpg" },
            { value: "other", label: "Other / unlisted model", sub: "Not pictured above", points: 0, imageUrl: "/icons/model-other.svg", allowFreeText: true },
          ],
        },
    ...
    },
    {
      ...
      questions: [
        ...
        { type: "radio", label: "Is the AED (1) cabinet intact and accessible?", required: true, fieldRole: "aed_cabinet_ok", options: YES_NO(2, 0, "Yes", "No", "/reference/aed-cabinet-installed.jpg", "/reference/aed-cabinet-inaccessible.jpg") },
        ...
        { type: "radio", label: "Is the AED (2) cabinet intact and accessible?", required: false, unscored: true, fieldRole: "aed_cabinet_ok_2", options: YES_NO(2, 0, "Yes", "No", "/reference/aed-cabinet-installed.jpg", "/reference/aed-cabinet-inaccessible.jpg") },
      ],
    },
    {
      letter: "R",
      ...
      questions: [
        ...
        { type: "radio", label: "Is there any warning beep or error message on AED (1)?", required: true, options: [{ value: "no", label: "No — no warning beep or error", points: 3, imageUrl: "/reference/beep-no.jpg" }, { value: "yes", label: "Yes — warning beep or error present", points: 0, imageUrl: "/reference/beep-yes.jpg" }] },
        {
          type: "radio",
        ...
        { type: "radio", label: "Is there any warning beep or error message on AED (2)?", required: false, unscored: true, options: [{ value: "no", label: "No — no warning beep or error", points: 3, imageUrl: "/reference/beep-no.jpg" }, { value: "yes", label: "Yes — warning beep or error present", points: 0, imageUrl: "/reference/beep-yes.jpg" }] },
        {
          type: "radio",
      ...
      questions: [
        {
          ...
          required: true,
          // AEDSmartX is this campaign's own platform — kept strictly at or
          // above every other option's points (it already defined this
          // question's 5-point ceiling; the others are now shifted below it
          // instead of tied with it).
          options: [
            { value: "aedsmartx", label: "Yes — AEDSMARTX", points: 5, imageUrl: "/icons/track-app-b.svg" },
            { value: "plustrack", label: "Yes — Plus Track", points: 4, imageUrl: "/icons/track-app-a.svg" },
            { value: "manual", label: "Yes — manual log / checklist register", points: 2, imageUrl: "/icons/track-manual.svg" },
