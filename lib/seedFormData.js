...
export function buildSeedSections() {
  return [
    ...
    },
    {
      ...
      visibleIfValue: "yes",
      questions: [
        { type: "radio", label: "Is the battery installed correctly?", required: true, fieldRole: "battery_attached", options: YES_NO(5, 0, "Yes", "No", "/reference/frx-battery-attached.jpg", "/icons/battery-bad.svg") },
        { type: "radio", label: "Are the pads connected and sealed?", required: true, hint: "The pouch should lie flat with an unbroken seal — a curled or air-gapped edge means the pads have been exposed.", fieldRole: "pads_connected", options: YES_NO(5, 0, "Yes", "No", "/reference/frx-pads-connected.jpg", "/icons/pads-unsealed.svg") },
        ...
        { type: "radio", label: "Is the AED cabinet intact and accessible?", required: true, fieldRole: "aed_cabinet_ok", options: YES_NO(2, 0, "Yes", "No", "/reference/aed-cabinet-example.jpg", "/icons/cabinet-bad.svg") },
      ],
    },
    {
      letter: "R",
