...
export function buildSeedSections() {
  return [
    ...
    },
    {
      ...
      visibleIfValue: "yes",
      questions: [
        { type: "radio", label: "Is the battery installed correctly?", required: true, options: YES_NO(5, 0, "Yes", "No", "/icons/battery-ok.svg", "/icons/battery-bad.svg") },
        { type: "radio", label: "Are the pads connected and sealed?", required: true, hint: "The pouch should lie flat with an unbroken seal — a curled or air-gapped edge means the pads have been exposed.", options: YES_NO(5, 0, "Yes", "No", "/icons/pads-sealed.svg", "/icons/pads-unsealed.svg") },
        ...
        { type: "radio", label: "Is the AED cabinet intact and accessible?", required: true, options: YES_NO(2, 0, "Yes", "No", "/icons/cabinet-ok.svg", "/icons/cabinet-bad.svg") },
      ],
    },
    {
      letter: "R",
    ...
    },
    {
      ...
      visibleIfValue: "yes",
      questions: [
        { type: "text", label: "Enter the serial number of AED (1)", required: true },
        { type: "date", label: "Select Battery (1) expiry date", required: true, hint: "Example: 7 January 2029" },
        { type: "radio", label: "Battery (1) expiry status", required: true, derivedFromPreviousDate: true, options: EXPIRY_OPTIONS },
        { type: "date", label: "Electrode pad (1) expiry date", required: true, hint: "Example: 7 January 2029" },
