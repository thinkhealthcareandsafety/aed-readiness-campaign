  ...
  return [
    ...
    },
    {
      ...
      questions: [
        ...
        { type: "radio", label: "Is the AED (2) cabinet intact and accessible?", required: false, unscored: true, fieldRole: "aed_cabinet_ok_2", options: YES_NO(2, 0, "Yes", "No", "/icons/cabinet-ok.svg", "/icons/cabinet-bad.svg") },
      ],
    },
    {
      letter: "R",
    ...
    },
    {
      ...
      questions: [
        ...
        { type: "date", label: "Select Battery (2) expiry date", required: false, fieldRole: "battery_expiry_date_2" },
        ...
        { type: "date", label: "Expiry date of Electrode pads (2)", required: false, fieldRole: "pads_expiry_date_2" },
