  ...
  return [
    ...
    },
    {
      ...
      questions: [
        ...
        { type: "radio", label: "Is the AED (1) cabinet intact and accessible?", required: true, fieldRole: "aed_cabinet_ok", options: YES_NO(2, 0, "Yes", "No", "/reference/aed-cabinet-example.jpg", "/reference/aed-cabinet-inaccessible.jpg") },
