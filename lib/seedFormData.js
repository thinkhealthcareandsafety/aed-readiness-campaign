  ...
  return [
      ...
      questions: [
        {
          ...
          options: YES_NO(0, 0, "Yes", "No", "/reference/aed-cabinet-ready.jpg", "/icons/aed-absent.svg"),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        { type: "radio", label: "Is the battery (1) installed correctly?", required: true, fieldRole: "battery_attached", options: YES_NO(5, 0, "Yes", "No", "/reference/frx-battery-attached.jpg", "/icons/battery-bad.svg") },
        { type: "radio", label: "Are the pads (1) connected and sealed?", required: true, hint: "The pouch should lie flat with an unbroken seal — a curled or air-gapped edge means the pads have been exposed.", fieldRole: "pads_connected", options: YES_NO(5, 0, "Yes", "No", "/reference/frx-pads-connected.jpg", "/icons/pads-unsealed.svg") },
        { type: "radio", label: "Is there any visible damage on AED (1) (cracks, swelling, or leakage)?", required: true, options: YES_NO(0, 3, "Yes", "No — sound condition", "/icons/damage-yes.svg", "/icons/damage-no.svg") },
        { type: "radio", label: "Is the AED (1) cabinet intact and accessible?", required: true, fieldRole: "aed_cabinet_ok", options: YES_NO(2, 0, "Yes", "No", "/reference/aed-cabinet-example.jpg", "/icons/cabinet-bad.svg") },
        ...
        // actually had.
        { type: "radio", label: "Is the battery (2) installed correctly?", required: false, unscored: true, options: YES_NO(5, 0, "Yes", "No", "/icons/battery-ok.svg", "/icons/battery-bad.svg") },
        { type: "radio", label: "Are the pads (2) connected and sealed?", required: false, unscored: true, options: YES_NO(5, 0, "Yes", "No", "/icons/pads-sealed.svg", "/icons/pads-unsealed.svg") },
        { type: "radio", label: "Is there any visible damage on AED (2) (cracks, swelling, or leakage)?", required: false, unscored: true, options: YES_NO(0, 3, "Yes", "No — sound condition", "/icons/damage-yes.svg", "/icons/damage-no.svg") },
        { type: "radio", label: "Is the AED (2) cabinet intact and accessible?", required: false, unscored: true, options: YES_NO(2, 0, "Yes", "No", "/icons/cabinet-ok.svg", "/icons/cabinet-bad.svg") },
      ],
    },
    {
      letter: "R",
