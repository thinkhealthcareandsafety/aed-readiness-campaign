...
export const PRIZES = [
  { id: "pads", label: "Replacement electrode pads", color: "var(--accent)" },
  { id: "battery", label: "AED battery pack", color: "var(--structure)" },
  { id: "stretcher", label: "Folding rescue stretcher", color: "var(--ready)" },
  { id: "first_aid_kit", label: "First-aid kit", color: "var(--warn)" },
  { id: "aedsmartx", label: "AEDSmartX subscription", color: "var(--accent-deep)" },
];
