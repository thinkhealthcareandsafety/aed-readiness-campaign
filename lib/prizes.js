...
export const PRIZES = [
  { id: "pads", label: "Replacement electrode pads", icon: "🩹", image: "/prizes/pads.jpg", color: "#2f5d5a" },
  { id: "battery", label: "AED battery pack", icon: "🔋", image: "/prizes/battery.jpg", color: "#1c2430" },
  { id: "stretcher", label: "Folding rescue stretcher", icon: "🛏️", image: "/prizes/stretcher.jpg", color: "#dcd6c8" },
  { id: "first_aid_kit", label: "Fast Response Kit", icon: "🧰", image: "/prizes/first-aid.jpg", color: "#a6540f" },
  { id: "aedsmartx", label: "AEDSmartX subscription", icon: "📲", image: "/prizes/subscription.jpg", color: "#1e3f3d" },
];
