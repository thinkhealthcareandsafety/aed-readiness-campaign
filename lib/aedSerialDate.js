...
// AEDs don't have a fixed expiration date the way batteries/pads do (that's
// tracked separately, already, elsewhere in this form) — manufacturers
// generally cite an 8-15 year *service life* instead, and Philips' own
// HS1/FRx warranty specifically runs 8 years. This is framed as an
// age advisory, not a certain "expired" fact, because it isn't one.
const DEVICE_AGE_WARNING_YEARS = 8;
